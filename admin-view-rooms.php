...
<body>
    <ul class="button">
        <li>
            <a class="nav-link" href="room_body.php">ADD ROOMS</a>
        </li>
    </ul>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="admin-edit-rooms.php?r_id=<?php echo $row['r_id']; ?>" class="btn-edit" onclick="return confirm('Do you want to edit?')">Edit</a>
                            </td>
                            <td class="action-links">
                                <a href="admin-view-rooms.php?r_id=<?php echo $row['r_id']; ?>" class="btn-delete" onclick="return confirm('Do you want to delete?')">Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
